    ...
    <div>
      <div className="about">
        ...
        <div className="p__text">
          Highly Favored is a video editing agency whose mission is to provide
          clients with an opportunity to tell their stories and reach more
          people with video.
        </div>
        <br />
        <div className="p__text">
          We started Highly Favored after we realized that entrepreneurs,
        ...
        <div className="about__img">
          <div className="p1">
            ...
            <div>
              ...
              <div className="name__text">
                <i>Co-Founder of Highly Favored</i>
              </div>
            </div>
          </div>
          ...
          <div className="p1">
            ...
            <div>
              ...
              <div className="name__text">
                <i>Senior Editor of Highly Favored</i>
              </div>
            </div>
          </div>
        </div>
